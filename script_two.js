...
console.log(snake_banned_direction)
...
// player promps
// ................
// const start_button = getElementById('snake-game-start-button'); //button of the form
// start_button.addEventListener("click", function(){
//   const user = getElementById('snake-user-name');
//   const game_difficulty = getElementById('snake-game-difficulty'); //easy || medium || hard
//   const game_field_size.height = getElementById('snake-field-height'); //(min 5 max 100)
//   const game_field_size.width = getElementById('snake-field-width'); //(min 5 max 100)

// remove form from grid and replace it with game field specified by user

setTimeout(function() {
game_running = true //delay turning the game on until field and snake is created and user has time to take it in
}, 1000);
